...
import { defaultMatrizValue, matrizInputPlaceholder } from "../constants"
...
export default function MatrizForm({ setMatriz }: MatrizFormProps) {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="w-full flex flex-col space-y-[24px]">
            <TextInput register={register} label="Matriz" name="matriz" placeholder={matrizInputPlaceholder} error={errors["matriz"]?.message} />
